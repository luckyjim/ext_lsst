...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
    			description='Create a SGE script array job to process LSST image with 1 step. Used singularity. Load balancing is 1 job by focal plan.')
    ...
    if my_pars.data_in_sps_or_eas == 'sps':
        ...
        opli = pli.ProcessStage1LsstEasIn()
    ...
    opli.create_script_sge_for_stage1_1step()
